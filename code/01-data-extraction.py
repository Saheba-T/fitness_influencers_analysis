...
import os
import pandas as pd
# Module to scrape channels and videos
...
for c in channels_df['ChannelName'].unique():
    ...
    playlist_id = channels_df.loc[channels_df['ChannelName']
                                  == c, 'playlistID'].iloc[0]
...
channels_df.to_csv(
    project_dir + "/data/raw/fitness_channels_2023_07_11.csv", index=False)
video_df.to_csv(
    project_dir + "/data/raw/fitness_videos_2023_07_11.csv", index=False)
